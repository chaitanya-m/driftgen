/*
 *    ADWINMonotoneChangeDetector.java
 ...
 * @version $Revision: 7 $
 */
public class ADWINMonotoneChangeDetector extends AbstractChangeDetector {

    protected ADWINMonotone adwin;
    ...
    public void resetLearning() {
        adwin = new ADWINMonotone(this.deltaAdwinOption.getValue());
    }
