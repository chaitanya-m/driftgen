 ...
 * @version $Revision: 1 $
 */
public class ARF extends AbstractClassifier implements MultiClassClassifier,
                                                                        CapabilitiesHandler {
    ...
    public ClassOption treeLearnerOption = new ClassOption("treeLearner", 'l',
            "Random Forest Tree.", ARFBaseTree.class,
            "ARFVFDT -e 2000000 -g 50 -c 0.01");
    ...
    public void resetLearningImpl() {
        ...
        if(numberOfJobs != ARF.SINGLE_THREAD && numberOfJobs != 1)
...
//        BasicClassificationPerformanceEvaluator classificationEvaluator = (BasicClassificationPerformanceEvaluator) getPreparedClassOption(this.evaluatorOption);
        ...
        //  ARF.FEATURES_M then nothing is performed in the
