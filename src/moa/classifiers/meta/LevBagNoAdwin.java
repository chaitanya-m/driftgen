 ...
 * @version $Revision: 7 $
 */
public class LevBagNoAdwin extends AbstractClassifier implements MultiClassClassifier,
CapabilitiesHandler {
	...
	public FlagOption adwinEnabledOption = new FlagOption("enableAdwin", 'A',
			"Use ADWIN to detect change and replace trees");
	...
	public MultiChoiceOption leveraginBagAlgorithmOption = new MultiChoiceOption(
			"leveraginBagAlgorithm", 'm', "Leveraging Bagging to use.", new String[]{
					"LevBag", "LevBagME", "LevBagHalf", "LevBagWT", "LeveragingSubag"},
	...
	public void resetLearningImpl() {
		...
		if (this.adwinEnabledOption.isSet()) {
	...
	public void trainOnInstanceImpl(Instance inst) {
		...
		if (Change && this.adwinEnabledOption.isSet()) {
	...
	public ImmutableCapabilities defineImmutableCapabilities() {
		if (this.getClass() == LevBagNoAdwin.class)
