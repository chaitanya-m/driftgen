 ...
 * @version $Revision: 7 $
 */
public class EFDT2 extends AbstractClassifier {
    ...
    public static class Node extends AbstractMOAObject {
        ...
        public double[] getClassVotes(Instance inst, EFDT2 ht) {
            return this.observedClassDistribution.getArrayCopy();
        }
        ...
        public void describeSubtree(EFDT2 ht, StringBuilder out,
                int indent) {
    ...
    public static abstract class LearningNode extends Node {
        ...
        public abstract void learnFromInstance(Instance inst, EFDT2 ht);
    }
    ...
    public static class InactiveLearningNode extends LearningNode {
        ...
        @Override
        public void learnFromInstance(Instance inst, EFDT2 ht) {
    ...
    public static class ActiveLearningNode extends LearningNode {
        ...
        public AttributeSplitSuggestion[] getBestSplitSuggestions(
                SplitCriterion criterion, EFDT2 ht) {
