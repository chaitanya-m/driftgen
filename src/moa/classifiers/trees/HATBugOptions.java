...
import moa.classifiers.trees.HAT.AdaSplitNode;
import moa.classifiers.trees.HAT.NewNode;
...
public class HATBugOptions extends VFDT {
 ...
 /*   public MultiChoiceOption leafpredictionOption = new MultiChoiceOption(
    ...
    public static class AdaSplitNode extends SplitNode implements NewNode {
		...
		public Instance computeErrorChangeAndWeightInst(Instance inst, HATBugOptions ht, SplitNode parent, int parentBranch) {
