 ...
 * @version $Revision: 7 $
 */
public class HATEidetic extends VFDTUnforgetting {
 ...
 /*   public MultiChoiceOption leafpredictionOption = new MultiChoiceOption(
    ...
    public interface NewNode {
        ...
        public void killTreeChilds(HATEidetic ht);

        public void learnFromInstance(Instance inst, HATEidetic ht, SplitNode parent, int parentBranch);
...
//        	}
        ...
        public double[] getClassVotes(Instance inst, VFDTUnforgetting ht) {
            double[] dist;
            int predictionOption = ((HATEidetic) ht).leafpredictionOption.getChosenIndex();
