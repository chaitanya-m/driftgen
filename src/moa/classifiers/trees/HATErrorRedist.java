 ...
 * @version $Revision: 7 $
 */
public class HATErrorRedist extends VFDT {
 ...
 /*   public MultiChoiceOption leafpredictionOption = new MultiChoiceOption(
    ...
    public interface NewNode {
        ...
        public void killTreeChilds(HATErrorRedist ht);

        public void learnFromInstance(Instance inst, HATErrorRedist ht, SplitNode parent, int parentBranch);
...
//        	}
        ...
        public double[] getClassVotes(Instance inst, VFDT ht) {
            double[] dist;
            int predictionOption = ((HATErrorRedist) ht).leafpredictionOption.getChosenIndex();
