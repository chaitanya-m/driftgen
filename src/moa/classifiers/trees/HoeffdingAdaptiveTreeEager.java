/*
 *    HoeffdingAdaptiveTreeEager.java
 ...
 *
 * <ul>
 * <li> Same parameters as <code>HoeffdingTreeOriginalEagerNBAdaptive</code></li>
 ...
 * @version $Revision: 7 $
 */
public class HoeffdingAdaptiveTreeEager extends HoeffdingTreeOriginalEager {
 ...
 /*   public MultiChoiceOption leafpredictionOption = new MultiChoiceOption(
    ...
    public interface NewNode {
        ...
        public void killTreeChilds(HoeffdingAdaptiveTreeEager ht);

        public void learnFromInstance(Instance inst, HoeffdingAdaptiveTreeEager ht, SplitNode parent, int parentBranch);
    ...
    public static class AdaLearningNode extends LearningNodeNBAdaptive implements NewNode {
        ...
        @Override
        public double[] getClassVotes(Instance inst, HoeffdingTreeOriginalEager ht) {
            double[] dist;
            int predictionOption = ((HoeffdingAdaptiveTreeEager) ht).leafpredictionOption.getChosenIndex();
   ...
   @Override
    ...
    public ImmutableCapabilities defineImmutableCapabilities() {
        if (this.getClass() == HoeffdingAdaptiveTreeEager.class)
