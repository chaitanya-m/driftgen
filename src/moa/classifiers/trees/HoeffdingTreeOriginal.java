 ...
 * @version $Revision: 7 $
 */
public class HoeffdingTreeOriginal extends AbstractClassifier {
...
public FlagOption binarySplitsOption = new FlagOption("binarySplits", 'b',
    ...
    public static class Node extends AbstractMOAObject {
        ...
        public double[] getClassVotes(Instance inst, HoeffdingTreeOriginal ht) {
            return this.observedClassDistribution.getArrayCopy();
        }
        ...
        public void describeSubtree(HoeffdingTreeOriginal ht, StringBuilder out,
                int indent) {
    ...
    public static abstract class LearningNode extends Node {
        ...
        public abstract void learnFromInstance(Instance inst, HoeffdingTreeOriginal ht);
    }
    ...
    public static class InactiveLearningNode extends LearningNode {
        ...
        @Override
        public void learnFromInstance(Instance inst, HoeffdingTreeOriginal ht) {
    ...
    public static class ActiveLearningNode extends LearningNode {
        ...
        public AttributeSplitSuggestion[] getBestSplitSuggestions(
                SplitCriterion criterion, HoeffdingTreeOriginal ht) {
