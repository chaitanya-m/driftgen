/*
 *    HoeffdingTreeOriginalEager.java
 ...
 * @version $Revision: 7 $
 */
public class HoeffdingTreeOriginalEager extends AbstractClassifier implements MultiClassClassifier,
                                                                 CapabilitiesHandler {
...
public FlagOption binarySplitsOption = new FlagOption("binarySplits", 'b',
    ...
    public static class Node extends AbstractMOAObject {
        ...
        public void describeSubtree(HoeffdingTreeOriginalEager ht, StringBuilder out,
                int indent) {
    ...
    public static abstract class LearningNode extends Node {
        ...
        public abstract void learnFromInstance(Instance inst, HoeffdingTreeOriginalEager ht);
    }
    ...
    public static class InactiveLearningNode extends LearningNode {
        ...
        @Override
        public void learnFromInstance(Instance inst, HoeffdingTreeOriginalEager ht) {
    ...
    public static class ActiveLearningNode extends LearningNode {
        ...
        public AttributeSplitSuggestion[] getBestSplitSuggestions(
                SplitCriterion criterion, HoeffdingTreeOriginalEager ht) {
    ...
    public ImmutableCapabilities defineImmutableCapabilities() {
      if (this.getClass() == HoeffdingTreeOriginalEager.class)
