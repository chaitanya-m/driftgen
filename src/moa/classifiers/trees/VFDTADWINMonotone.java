/*
 *    VFDTADWINMonotone.java
 *    Chaitanya Manapragada
 *    Based on code by Albert Bifet. Original License included.
 */
/*
...
import moa.classifiers.core.driftdetection.ADWINMonotone;
 ...
 *
 * <p>This adaptive Hoeffding Tree uses ADWINMonotone to monitor performance of
 ...
 * @version $Revision: 7 $
 */
public class VFDTADWINMonotone extends HoeffdingTree {

    private static final long serialVersionUID = 1L;

    @Override
    public String getPurposeString() {
        return "Hoeffding Adaptive Tree for evolving data streams that uses ADWINMonotone to replace branches for new ones.";
    }
 ...
 /*   public MultiChoiceOption leafpredictionOption = new MultiChoiceOption(
    ...
    public interface NewNode {
        ...
        public void killTreeChilds(VFDTADWINMonotone ht);

        public void learnFromInstance(Instance inst, VFDTADWINMonotone ht, SplitNode parent, int parentBranch);
    ...
    public static class AdaSplitNode extends SplitNode implements NewNode {
        ...
        protected ADWINMonotone estimationErrorWeight;
        ...
        public void learnFromInstance(Instance inst, VFDTADWINMonotone ht, SplitNode parent, int parentBranch) {
            ...
            if (this.estimationErrorWeight == null) {
                this.estimationErrorWeight = new ADWINMonotone();
            }
    ...
    public static class AdaLearningNode extends LearningNodeNBAdaptive implements NewNode {
        ...
        public double[] getClassVotes(Instance inst, HoeffdingTree ht) {
            double[] dist;
            int predictionOption = ((VFDTADWINMonotone) ht).leafpredictionOption.getChosenIndex();
