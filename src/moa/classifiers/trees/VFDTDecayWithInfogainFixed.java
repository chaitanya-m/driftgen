 ...
 * @version $Revision: 7 $
 */
public class VFDTDecayWithInfogainFixed extends AbstractClassifier {
    ...
    public static class Node extends AbstractMOAObject {
        ...
        public double[] getClassVotes(Instance inst, VFDTDecayWithInfogainFixed ht) {
            return this.observedClassDistribution.getArrayCopy();
        }
        ...
        public void describeSubtree(VFDTDecayWithInfogainFixed ht, StringBuilder out,
                int indent) {
    ...
    public static abstract class LearningNode extends Node {
        ...
        public abstract void learnFromInstance(Instance inst, VFDTDecayWithInfogainFixed ht);
    }
    ...
    public static class InactiveLearningNode extends LearningNode {
        ...
        @Override
        public void learnFromInstance(Instance inst, VFDTDecayWithInfogainFixed ht) {
    ...
    public static class ActiveLearningNode extends LearningNode {
        ...
        public AttributeSplitSuggestion[] getBestSplitSuggestions(
                SplitCriterion criterion, VFDTDecayWithInfogainFixed ht) {
...
//                if(shouldSplit && this.treeRoot.subtreeDepth() >= 3){
//                	//System.out.println("======================= " + bestSuggestion.merit + "    " + (hoeffdingBound < this.tieThresholdOption.getValue()));
//                	//System.out.println("======================= " + bestSuggestion.merit + "    " + secondBestSuggestion.merit);
//                	//System.out.println("======================= " + bestSuggestion.splitTest.getAttsTestDependsOn()[0]
//                			+ "    " + secondBestSuggestion.splitTest.getAttsTestDependsOn()[0]);
//
//                }

                //If you happen to be a nominal attribute that has already been used down your learning path
                if(shouldSplit){
            ...
            if (shouldSplit) {
            	...
            	splitCount++;
            	//System.out.println(numInstances  + " " + this.treeRoot.subtreeDepth());
