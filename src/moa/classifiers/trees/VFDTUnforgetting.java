 ...
 * @version $Revision: 7 $
 */
public class VFDTUnforgetting extends AbstractClassifier {
    ...
    public static abstract class LearningNode extends Node {
        ...
        public abstract void learnFromInstance(Instance inst, VFDTUnforgetting ht);
    }
    ...
    public static class InactiveLearningNode extends LearningNode {
        ...
        @Override
        public void learnFromInstance(Instance inst, VFDTUnforgetting ht) {
        ...
        if (!node.observedClassDistributionIsPure()) {
            ...
            if (bestSplitSuggestions.length < 2) {
            	...
            	double hoeffdingBound = computeHoeffdingBound(splitCriterion.getRangeOfMerit(node.getObservedClassDistribution()),
                        this.splitConfidenceOption.getValue(), node.getWeightSeen()); // Use node.nodeTime instead if there is decay in the weights!!
