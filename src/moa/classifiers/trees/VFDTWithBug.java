 ...
 * @version $Revision: 7 $
 */
public class VFDTWithBug extends AbstractClassifier {
...
public FlagOption binarySplitsOption = new FlagOption("binarySplits", 'b',
    ...
    public static class Node extends AbstractMOAObject {
        ...
        public double[] getClassVotes(Instance inst, VFDTWithBug ht) {
            return this.observedClassDistribution.getArrayCopy();
        }
        ...
        public void describeSubtree(VFDTWithBug ht, StringBuilder out,
                int indent) {
    ...
    public static abstract class LearningNode extends Node {
        ...
        public abstract void learnFromInstance(Instance inst, VFDTWithBug ht);
    }
    ...
    public static class InactiveLearningNode extends LearningNode {
        ...
        @Override
        public void learnFromInstance(Instance inst, VFDTWithBug ht) {
    ...
    public static class ActiveLearningNode extends LearningNode {
        ...
        public AttributeSplitSuggestion[] getBestSplitSuggestions(
                SplitCriterion criterion, VFDTWithBug ht) {
